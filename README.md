...
**[Bookstore]** a Single Page App (SPA) that allows users to:
...
- [Watch it in action](https://dgcuenca.github.io/bookstore/)
...
Feel free to check the [issues page](https://github.com/dgcuenca/bookstore/issues).
